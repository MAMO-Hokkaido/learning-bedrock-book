...
#### 2. ナレッジベースを作成する
   ...
   - コストを掛けずにRAGを試用するために、**構造化データストアを含むナレッジベース**を作成する。
   - 参考：[Bedrockナレッジベースの「自然言語 to SQL」で社内DB検索エージェントを作ろう！ #AWS - Qiita](https://qiita.com/minorun365/items/31b4a2835a6d0eca109a)
     ![image](https://github.com/user-attachments/assets/47906e11-174f-4fe5-ae4b-9e000e92824d)
